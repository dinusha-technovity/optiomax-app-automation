...
public class AddNewAssetRequisitionPage {
    ...
    private By selectWorkflow = By.xpath("");
    private By assignWorkflowSubmit = By.xpath("");
...
//    public void selectSuppliers(String supplier) {
//        Select select = new Select(driver.findElement(selectSupplier));
...
//    }
    ...
    public void clickSpace() {
    	driver.findElement(spaceClick).click();
    }
    
    public void selectWorkflow() {
    	driver.findElement(selectWorkflow).click();
    }
    
    public void selectAssignWorkflow() {
    	driver.findElement(assignWorkflowSubmit).click();
    }
